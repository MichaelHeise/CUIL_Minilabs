...
async def send_http_request(host, port, path, HTTP_version=HTTP_1):
    http_1 = HTTP_version == HTTP_1
...
if __name__ == "__main__":
    ...
    parser.add_argument("--http_version", choices=[HTTP_1, HTTP_2], default=HTTP_1, help="HTTP version to use (1 or 2)")
