...
\begin{enumerate}
    \item TCP Handshake
    \subitem Client sendet SYN \textrightarrow Verbidnungsanfrage (Pakete 3)
    ...
    \item HTTP/2 Connection Preface \textrightarrow Info über die Unterstützung von HTTP/2 (Paket 6)
...
Dann wird auf der anderen Seite das Pakte empfangen und basierend auf der Stream ID zugeordnet und verarbeitet. Sobald die Antwort vollständig ist, wird der Stream geschlossen.