...
\textbf{Link Einstellungen}\label{sec:link_einstellungen}

Der Link zwischen den Hosts kann in der Bandbreite, Latenz, Verzögerung und Paketverlust konfiguriert werden.

\textbf{TCP Staukontrolle}\label{sec:tcp_staukontrolle_einstellungen}
...
\textbf{iperf3} \label{sec:iperf3_docker_tool}
...
\textbf{udp} \label{sec:udp_docker_tool}
...
\textbf{tcp} \label{sec:tcp_docker_tool}
...
\textbf{PCAP Capture} \label{sec:pcap_docker_capture}
...
\textbf{Shell} \label{sec:shell_docker_tool}
