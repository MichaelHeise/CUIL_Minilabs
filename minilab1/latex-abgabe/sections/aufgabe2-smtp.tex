...
Der Server akzeptierte die Anfrage und bestätigte die Zustellung mit \texttt{250 ok: Message 406218478 accepted}~\ref{fig:smtp_attempts}.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textwidth]{res/smtp_attempt1.png}
    \includegraphics[width=0.45\textwidth]{res/smtp_attempt2.png}
    \caption{Erster SMTP-Versuch (links): Alle Befehle als Block eingefügt. Zweiter SMTP Versuch (rechts): Korrekte Befehlsfolge}\label{fig:smtp_attempts}
\end{figure}
...
Im zweiten Versuch~\ref{fig:smtp_attempts} wurden die Befehle daher einzeln geschickt.
